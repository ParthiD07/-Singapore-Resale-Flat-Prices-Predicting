...
if menu == 'Flat Resale Price Prediction':
    ...
    with st.form('price_prediction'):
        ...
        if button:
            ...
            user_input=np.array([[Year,Flat_Type_encoded,Town_encoded,Story_Starts_at,Lease_Commence_Year,Flat_Model_encoded,Floor_Area_sqm,Story_Ends_at]])
